...
**Author:** Jessie
**Date:** 2026-03-04
**Status:** Draft v5 — 已整合 Kevin review 反馈（#152-#157 + delivery 智能化 + 总开关 + popup 保留分发规则）
...
*PRD by Jessie, 2026-03-04 (v5). Based on issue #150 (Kevin) + Kevin review #152-#157 + delivery 智能化 + 总开关 + popup 保留分发规则 + ClawMark extension v0.6.1 代码分析。*
